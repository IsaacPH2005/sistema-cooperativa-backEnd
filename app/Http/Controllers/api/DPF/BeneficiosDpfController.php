...
class BeneficiosDpfController extends Controller
{
    /**
    ...
    {
        $items = BeneficiosDpf::orderBy('id', 'desc')->paginate(10);
    ...
    {
        $items = BeneficiosDpf::where('estado', true)->get();
