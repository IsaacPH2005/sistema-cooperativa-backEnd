...
class CaracteristicasController extends Controller
{
    ...
    {
        $items = CaracteristicasCuentaDeAhorro::orderBy('id', 'desc')->paginate(10);
    ...
    public function store(Request $request)
    {
        ...
        $item = new CaracteristicasCuentaDeAhorro();
    ...
    {
        $item = CaracteristicasCuentaDeAhorro::find($id);
        if (!$item) {
    ...
    {
        $items = CaracteristicasCuentaDeAhorro::where('estado', true)->get();
